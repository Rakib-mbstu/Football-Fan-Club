...
type TeamData = {
  [teamName: string]: TeamDataEntry;
};

export default function HeadToHeadClient({ teamData }: { teamData: TeamData }) {
  const [comparisonType, setComparisonType] = useState("teams");
  // Team state
  const [selectedTeams, setSelectedTeams] = useState({
    teamA: Object.keys(teamData)[0] || "",
    teamB: Object.keys(teamData)[1] || "",
  });
  ...
  const getLastFiveDisplay = (results: string[]) => {
      ...
      <div className="bg-gray-800 rounded-lg shadow-sm p-4 sm:p-6 mb-4 sm:mb-6">
        <div className="flex flex-col sm:flex-row gap-4">
          <div className="flex-1">
            ...
            <select
              className="w-full p-3 border  bg-gray-800 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm sm:text-base"
      ...
      <div className="flex flex-col lg:grid lg:grid-cols-2 gap-4 mb-4 sm:mb-6">
        ...
        <div className="bg-slate-800 text-white rounded-lg p-4">
          <div className="flex items-center mb-3">
            <span className="text-xl sm:text-2xl mr-3">
              <Image
                src={getTeamData(selectedTeams.teamA).logo}
                alt={`logo`}
                width={40}
                height={40}
              />
        ...
        <div className="bg-slate-800 text-white rounded-lg p-4">
          <div className="flex items-center mb-3">
            <span className="text-xl sm:text-2xl mr-3">
              <Image
                src={getTeamData(selectedTeams.teamB).logo}
                alt={`logo`}
                width={40}
                height={40}
              />
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-4 sm:py-6">
        ...
        {comparisonType === "teams" ? renderTeamComparison() : ""}
      </div>
